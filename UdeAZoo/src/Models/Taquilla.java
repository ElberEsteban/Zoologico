...
public class Taquilla {   
    ...
    public Taquilla(){
        this.id = 1;
        taquillero = new Taquillero("010","Elber Esteban");
    ...
    public List<Cliente> obtenerClientes(){
        ...
        cte.add(new Cliente("104256987","Elber González",true,"100000",0,null,0));
        cte.add(new Cliente("15698789","Carlos Henao",false,"0",0,null,0));
        cte.add(new Cliente("22145896","Margot López",false,"0",0,null,0));
        return cte;
    }
    ...
    public List<Plan> obtenerPlanes(){
        ...
        pln.add(new Plan(4,"Membresia","25000",4,false,true,false,2));
    ...
    public Taquillero getTaquillero() { return taquillero; }
