...
public class GenerarPdf {
    ...
    public static void main(String[] args) {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("src/main/java/Documents/Informe Ventas.pdf"));
            document.open();

           Image image = Image.getInstance("src/main/java/Imges/logozoo.JPG");
